...
//import static com.era.StandardMatching.StandardMatching.matching;

/**
 * @author roman
 */
public class GetFingerData extends StandardMatching {
        ...
        try {
            ...
            if (standard.equals("S")) {
                if(modal.getAgentPoint() !=0  || modal.getCustNo() != 0){ // Here 0 means Agent Point Or Cust no is not selected
                    ...
                    StandardMatching standardMatching = new StandardMatching();
                    standardMatching.matching(modal,standard);
